                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              final exitontoresList =
                                  consultaPageExtintoresRowList
                                      .toList()
                                      .take(10)
                                      .toList();
                              ...
                              return ListView.separated(
                                ...
                                itemCount: exitontoresList.length,
                                separatorBuilder: (_, __) =>
                                    const SizedBox(height: 10.0),
                                itemBuilder: (context, exitontoresListIndex) {
                                  final exitontoresListItem =
                                      exitontoresList[exitontoresListIndex];
                                  return Container(
                                    width: 100.0,
                                    height: 100.0,
